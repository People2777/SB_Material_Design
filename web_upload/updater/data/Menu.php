<?php
try {
    $insq_menu = "INSERT INTO `:prefix:menu` (`id`, `text`, `description`, `url`, `system`, `enabled`, `priority`) VALUES";
    $qs = array("CREATE TABLE IF NOT EXISTS `:prefix:menu` ( `id` int(11) NOT NULL AUTO_INCREMENT, `text` varchar(256) NOT NULL, `description` varchar(450) NOT NULL, `url` varchar(300) NOT NULL, `system` tinyint(1) NOT NULL, `enabled` tinyint(1) NOT NULL, `priority` int(11) NOT NULL, PRIMARY KEY (`id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=8;",
